                                                ...
                                                <td style="width:100%">
                                                        <div class="replay-content" style="text-align: justify;padding-right: 50px;padding-left: 50px;">
                                                                ...
                                                                <div class="main-content">
                                                                        ...
                                                                        <p>Thank you very much for signing up at caringpeople.in !</p>

                                                                        <p>Please click on the below link to verify your email address:</p>

                                                                        <p><a style="background: rgb(52, 152, 219); color: rgb(255, 255, 255); font-size: 16px; padding: 10px 20px 10px 20px; text-decoration: none" href="http://<?= Yii::$app->getRequest()->serverName . Yii::$app->homeUrl ?>site/verification?token=<?= $id ?>" target="_blank">Click here</a></p>
