...
<div class="modal-content" id="pop-form">
        <div class="modal-header">
                ...
                <h4 class="modal-title pop-heading">Add Timing</h4>
        </div>
        ...
        <div class="modal-body">
                ...
                <div class="row">
                        ...
                        <div class='col-md-6 col-sm-6 col-xs-12 left_padd' style="margin-left: 20px;">
                                <label class="control-label" for="uploadcategory-sub_category">Timing</label>
                                <?= $form->field($model, 'timing')->textInput(['maxlength' => true])->label(FALSE) ?>
