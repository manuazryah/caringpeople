                ...
                <div class="row clearfix">
                        <form id="replacestaffSearch">
                                <fieldset class="col-sm-12" style="background: #eee;border: 1px solid #ccc; border-radius: 5px;padding: 5px;margin-bottom: 10px;">
                                        ...
                                        <input type="hidden" name="service_id" id="schedule_id" value="<?= $schedule_id; ?>">
                        ...
                        <form id="searchReplaceStaff">
                                <div class="col-sm-12 replace-results">
