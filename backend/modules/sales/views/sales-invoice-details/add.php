...
<script>
        $(document).ready(function () {
                ...
                if (report_id != '') {
                        window.open('<?= Yii::$app->homeUrl ?>sales/sales-invoice-details/report?id=' + report_id, 'print_popup', 'width=1200,height=500');
                }
        });
</script>
        ...
        <div class="col-md-12">
                ...
                <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                ...
                                <?php
                                // $default_partner = common\models\BusinessPartner::findOne(['id' => 1]);
                                $default_partner = [];
                                ?>
                                <div class="panel-body">
                                        ...
                                        <div class="sales-invoice-master-create">
                                                <div class="sales-invoice-master-form form-inline">
                                                        ...
                                                        <div class='col-md-2 col-sm-6 col-xs-12' >
                                                                <?php
                                                                if (Yii::$app->user->identity->branch_id != '0') {
                                                                        $patients = \common\models\PatientGeneral::find()->where(['branch_id' => Yii::$app->user->identity->branch_id])->all();
                                                                } else {
                                                                        $patients = \common\models\PatientGeneral::find()->all();
                                                                }
                                                                ?>

                                                                <?=
                                                                $form->field($model_sales_master, 'salesman')->dropDownList(
                                                                        ArrayHelper::map($patients, 'id', 'first_name'), ['prompt' => '--Select--'])
                                                                ?>
...
<script>
        $(document).ready(function () {
                ...
                $("#salesinvoicemaster-salesman").select2({
                        allowClear: true
                }).on('select2-open', function ()
                {
                        $(this).data('select2').results.addClass('overflow-hidden').perfectScrollbar();
...
<style>
        .field-salesinvoicemaster-due_date label{
                display: none;
        }
</style>
