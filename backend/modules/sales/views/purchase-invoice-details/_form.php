...
/* @var $model common\models\PurchaseInvoiceDetails */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="purchase-invoice-details-form form-inline">

        <?php $form = ActiveForm::begin(); ?>

        <div class='col-md-4 col-sm-6 col-xs-12'>    <?= $form->field($model, 'sales_invoice_master_id')->textInput() ?>

</div><div class='col-md-4 col-sm-6 col-xs-12'>    <?= $form->field($model, 'sales_invoice_number')->textInput(['maxlength' => true]) ?>

</div><div class='col-md-4 col-sm-6 col-xs-12'>    <?= $form->field($model, 'sales_invoice_date')->textInput() ?>

</div><div class='col-md-4 col-sm-6 col-xs-12'>    <?= $form->field($model, 'busines_partner_code')->textInput() ?>

</div><div class='col-md-4 col-sm-6 col-xs-12'>    <?= $form->field($model, 'item_id')->textInput() ?>
...
</div><div class='col-md-4 col-sm-6 col-xs-12'>    <?= $form->field($model, 'discount_type')->textInput() ?>

</div><div class='col-md-4 col-sm-6 col-xs-12'>    <?= $form->field($model, 'discount_value')->textInput(['maxlength' => true]) ?>
