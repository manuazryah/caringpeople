...
$this->params['breadcrumbs'][] = ['label' => 'Purchase Invoice Details', 'url' => ['index']];
        ...
        <div class="col-md-12">
                ...
                <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                ...
                                <?php // if ($model->flag == 0) { ?>
                                <?php // Html::a('<i class="fa fa-shopping-cart"></i><span>Proceed to Sale</span>', ['add-sale', 'id' => $model->id], ['class' => 'btn btn-blue btn-icon btn-icon-standalone btn-icon-standalone-right']) ?>
                                <?php // } else {  ?>
                                <!--                <button class="btn btn-blue btn-icon btn-icon-standalone btn-icon-standalone-right" style="background-color: #4c86cc;">
                                                    <i class="fa fa-shopping-cart" style="border-left-color: #2e6db8;background-color: #4c86cc;border-right-color: #4c86cc;"></i>
                                                    <span>Already Sailed</span>
                                                </button>-->
                                <?php // }
                                ?>
                                <div class="panel-body">
