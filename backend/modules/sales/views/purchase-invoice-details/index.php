...
/* @var $searchModel common\models\PurchaseInvoiceDetailsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Purchase Invoice';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="purchase-invoice-details-index">
                ...
                <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                        ...
                                        <?php // Html::a('<i class="fa fa-plus"></i><span>  New</span>', ['add'], ['class' => 'btn btn-warning']) ?>
...
//                            'sales_invoice_number',
                                                ...
                                                [
                                                    ...
                                                    'urlCreator' => function ($action, $model) {
                                                            if ($action === 'print') {
                                                                    $url = Url::to(['purchase-invoice-details/report', 'id' => $model->id]);
                                                                    return $url;
                                                            }
                                                            if ($action === 'view') {
                                                                    $url = Url::to(['purchase-invoice-details/view', 'id' => $model->id]);
                                                                    return $url;
                                                            }
                                                    }
                                                ],
