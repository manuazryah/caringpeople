...
class AccountsController extends Controller {
        ...
        public function actionIndex() {
                ...
                if (isset($_GET['AccountsSearch']['createdFrom'])) {

                        $from = date('Y-m-d', strtotime($_GET['AccountsSearch']['createdFrom']));
                } else {
                        $from = date('Y-m-d');
                }
                if (isset($_GET['AccountsSearch']['createdTo'])) {
                        $to = date('Y-m-d', strtotime($_GET['AccountsSearch']['createdTo']));
                } else {
                        $to = date('Y-m-d');
                }
