...
/* @var $searchModel common\models\MasterRelationshipsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Master Relationships';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="master-relationships-index">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 small-forms">
                                                <div class="header-small-forms">
                                                        ...
                                                        <?php } else { ?>
                                                                <h4>Update Nationality : <?= $model->title; ?></h4>
                                                        <?php } ?>
                                                </div>
