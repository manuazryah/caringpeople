        ...
        public function generateRow($model, $key, $index) {
                ...
                foreach ($this->getVisibleColumns() as $column) {
                        ...
                        $cell = $this->_objPHPExcelSheet->setCellValue(
                                self::columnName($this->_endCol) . ($index + $this->_beginRow + 1), !isset($value) || $value === '' ? '' : strip_tags($value), true
                        );
                ...
                foreach ($this->getVisibleColumns() as $n => $column) {
                        ...
                        if ($column->footer) {
                                ...
                                $cell = $this->_objPHPExcel->getActiveSheet()->setCellValue(
                                        self::columnName($this->_endCol) . ($row + 1), $footer, true
                                );
...
//                    ],
        ...
        protected function registerAssets() {
                ...
                $this->messages += [
                    'allowPopups' => Yii::t(
                            'kvexport', 'Disable any popup blockers in your browser to ensure proper download.'
                    ),
                    ...
                    'downloadComplete' => Yii::t(
                            'kvexport', 'Request submitted! You may safely close this dialog after saving your downloaded file.'
                    ),
                ];
