                                                ...
                                                <td style="width:100%">
                                                        <div class="replay-content" style="text-align: justify;padding-right: 50px;padding-left: 50px;">
                                                                ...
                                                                <div class="main-content">
                                                                        <p>Dear <?= $assigned_details->staff_name; ?>,</p>

                                                                        <p>This is a reminder that the following followup arrived soon!!</p>

                                                                        <p><a href="<?= Yii::$app->homeUrl; ?>followup/followups/view?data=<?= $data ?>">Click Here</a> to view that followup</a></p>
