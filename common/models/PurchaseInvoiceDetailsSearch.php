...
/**
 * PurchaseInvoiceDetailsSearch represents the model behind the search form about `common\models\PurchaseInvoiceDetails`.
 */
class PurchaseInvoiceDetailsSearch extends PurchaseInvoiceDetails {
    ...
    public function rules() {
        return [
            [['id', 'sales_invoice_master_id', 'busines_partner_code', 'item_id', 'base_unit', 'qty', 'discount_type', 'tax_id', 'status', 'CB', 'UB'], 'integer'],
            [['sales_invoice_number', 'sales_invoice_date', 'item_code', 'item_name', 'tax_percentage', 'reference', 'error_message', 'DOC', 'DOU', 'hsn'], 'safe'],
    ...
    public function search($params) {
        $query = PurchaseInvoiceDetails::find();
